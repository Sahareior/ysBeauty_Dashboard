  ...
  return (
    <div>
      ...
      <div className="flex justify-between items-center ">
        <div className="flex items-center gap-6 cursor-pointer mb-6">
          <FaChevronLeft />
        ...
        <div className="space-y-6 w-full">
          ...
          <div>
            ...
            {isEditing ? (
              ...
              <p className=" text-[22px] bg-[#F5F5F5] p-5 w-full">{form.firstName}</p>
            )}
          </div>
          ...
          <div>
            ...
            {isEditing ? (
              ...
              <p className=" text-[22px] bg-[#F5F5F5] p-5 w-full">{form.email}</p>
            )}
          </div>
          ...
          <div>
            ...
            {isEditing ? (
              ...
              <p className=" text-[22px] bg-[#F5F5F5] p-5 w-full">{form.phone}</p>
            )}
          </div>
